...
tags:
  ...
  - "少儿编程"
  - "海龟绘图 100 题"
description: "Python 海龟绘图详解——圆和圆弧绘制总结，整理绘图思路、示例代码和关键方法，帮助读者完成对应 Turtle 绘图练习。"
draft: false
---
...
**绘制速度慢**是因为我们实际上循环了 360 次，所以速度慢，可以考虑用 36 边形进行处理。

**无法确定圆的半径**可以通过计算来得到一个通解。
...
在我个人教学中，推荐使用**方法二。方法二是利用循环的思想逼近成圆。**
