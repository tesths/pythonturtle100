...
tags:
  ...
  - "少儿编程"
  - "海龟绘图 100 题"
description: "Python 海龟绘图——多边形绘制总结，整理绘图思路、示例代码和关键方法，帮助读者完成对应 Turtle 绘图练习。"
draft: false
---
...
但是此种方法无法在已有知识体系下明确多边形的边长（具体边长的值为 **$d = 2r \sin\left(\frac{180^\circ}{n}\right)$**）
